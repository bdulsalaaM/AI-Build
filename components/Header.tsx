...
const Header: React.FC<HeaderProps> = ({ currentUser, onAuthClick, onLogout, onHistoryClick }) => {
  return (
          ...
          <div className="flex items-center">
             {currentUser ? (
               <div className="flex items-center space-x-4">
                 ...
                 <button onClick={onHistoryClick} className="hidden sm:inline text-sm font-medium text-gray-500 hover:text-primary transition-colors">
                    Ride History
                 </button>
